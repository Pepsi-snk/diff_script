...
!(async () => {
    ...
    $.shareUuid = "5eae5243fc9f407dac7156054c7b9660"
    console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/mar2022/miFenJie/activity/1026270?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
...
async function run() {
    try {
        ...
        if($.index % 8 == 0) await $.wait(parseInt(Math.random() * 5000 + 30000, 10))
    } catch (e) {
        console.log(e)
    }
}
...
function getPostRequest(url, body, method="POST") {
    ...
    if(url.indexOf('https://lzdz1-isv.isvjcloud.com') > -1){
        headers["Referer"] = `https://lzdz1-isv.isvjcloud.com/dingzhi/mar2022/miFenJie/activity/1026270?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
    return new Promise(resolve => {
        let get = {
            url:`https://lzdz1-isv.isvjcloud.com/dingzhi/mar2022/miFenJie/activity/1026270?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
